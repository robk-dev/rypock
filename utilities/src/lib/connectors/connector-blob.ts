...
import { Container } from "../repo/repo-container";

import { IBlobStorageService, ILogger, ListContainersResponse } from "../interfaces";
...
export class BlobStorageService implements IBlobStorageService {
    ...
    constructor(options: IBlobOptions, private logger: ILogger) {
