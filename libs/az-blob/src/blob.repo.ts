import { IBlob } from './blob.repo.interface';
import { Aborter, AppendBlobURL, BlockBlobURL, BlobURL, ContainerURL, HttpRequestBody, PageBlobURL } from '@azure/storage-blob';
...
export class Blob implements IBlob {
    ...
    constructor(options: BlobOptions, private logger: any) {
